...
**Весь проект** (исходный код, скрипты сборки, документация и скомпилированные бинарные файлы) распространяется под **GNU Affero General Public License, версия 3.0 (AGPL-3.0-only)**. Полный текст лицензии приведён в файлах [`LICENSE.md`](LICENSE.md) и [`LICENSE-AGPL-3.0.md`](LICENSE-AGPL-3.0.md)`LICENSE-AGPL-3.0.md`, входящих в состав дистрибутива.
