...
**Весь проект** (исходный код, скрипты сборки, документация и скомпилированные бинарные файлы) распространяется под **GNU Affero General Public License, версия 3.0 (AGPL-3.0-only)**. Полный текст лицензии приведён в файлах [`LICENSE.md`](LICENSE.md) и `LICENSE-AGPL-3.0.md`, входящих в состав дистрибутива.

Проект использует **JUCE 8** по AGPL-маршруту. Любое распространение (в том числе модифицированных версий) должно соответствовать условиям AGPL-3.0. Если вы намерены распространять MIDIShip Bridge или производные работы в закрытом виде (без предоставления исходного кода), необходимо приобрести коммерческую лицензию на JUCE у **Raw Material Software** и следовать её условиям. Подробнее: [juce.com/legal/juce-8-licence](https://juce.com/legal/juce-8-licence/).

**Товарные знаки:** Cubase и VST являются товарными знаками Steinberg Media Technologies GmbH; HUI связан с Mackie; Kontakt и Omnisphere принадлежат их правообладателям. Данный проект не является официальным продуктом Steinberg, Mackie, Native Instruments или Spectrasonics.
