...
**The entire project** (source code, build scripts, documentation, and compiled binaries) is distributed under the **GNU Affero General Public License, version 3.0 (AGPL-3.0-only)**. The full license text is provided in the [`LICENSE.md`](LICENSE.md) and [`LICENSE-AGPL-3.0.md`](LICENSE-AGPL-3.0.md) files included in this distribution.
...
**Trademarks:** Cubase and VST are trademarks of Steinberg Media Technologies GmbH; HUI is associated with Mackie; Kontakt and Omnisphere are owned by their respective holders. This project is not an official product of Steinberg, Mackie, Native Instruments, or Spectrasonics.
